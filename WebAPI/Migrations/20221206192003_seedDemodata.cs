    ...
    public partial class seedDemodata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                    ...
                    Address2,CityId,FloorNo,TotalFloor,ReadyToMove,MainEntrance,Security,Maintenance,EstPossessionOn,Age,Description,PostedOn,PostedBy,LastUpdatedOn,LastUpdatedBy)
                    select 
                    1, --Sell Rent
